...
Vagrant.configure("2") do |config|
  config.vm.define "host01" do |host01|
   ...
   # host01.vm.network "private_network", type: "dhcp", virtual_box__intnet: true
   # host01.vm.network "forwarded_port", guest: 80, host: 8080
  ...
  #host01.vm.provision "shell", patch: "D:/VGtest/script.sh"
end
